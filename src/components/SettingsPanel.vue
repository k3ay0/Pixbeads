  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-start justify-end" @click.self="emit('close')">
    <div class="w-80 max-w-[90vw] h-full bg-white shadow-lg flex flex-col">
      ...
      <div class="flex items-center justify-between p-4 border-b border-gray-200">
        <h2 class="text-lg font-medium text-gray-800">设置</h2>
        <button
          @click="emit('close')"
      ...
      <div class="flex-1 overflow-y-auto p-4 space-y-6">
        <!-- 引导设置 -->
        <div>
          <h3 class="text-base font-medium text-gray-800 mb-3">智能引导</h3>
          <div class="space-y-3">
            <label class="flex items-center">
              ...
              />
              <div>
                <div class="text-sm font-medium text-gray-700">最近优先</div>
                <div class="text-xs text-gray-500">推荐距离最近的格子</div>
              </div>
            </label>
            ...
            <label class="flex items-center">
              ...
              />
              <div>
                <div class="text-sm font-medium text-gray-700">大块优先</div>
                <div class="text-xs text-gray-500">优先推荐大色块区域</div>
              </div>
            </label>
            ...
            <label class="flex items-center">
              ...
              />
              <div>
                <div class="text-sm font-medium text-gray-700">边缘优先</div>
                <div class="text-xs text-gray-500">先完成边缘，再填充内部</div>
              </div>
            </label>
          </div>
        </div>
        ...
        <!-- 显示设置 -->
        <div>
          <h3 class="text-base font-medium text-gray-800 mb-3">显示设置</h3>
          <div class="space-y-4">
            <!-- 分割线开关 -->
            <label class="flex items-center justify-between">
              <div>
                <div class="text-sm font-medium text-gray-700">显示分割线</div>
                <div class="text-xs text-gray-500">将画布分割成区块帮助定位</div>
              </div>
              <input
                type="checkbox"
            ...
            <label class="flex items-center justify-between">
              <div>
                <div class="text-sm font-medium text-gray-700">庆祝动画</div>
                <div class="text-xs text-gray-500">完成颜色时显示撒花效果</div>
              </div>
              <input
                type="checkbox"
        ...
        <!-- 进度重置 -->
        <div>
          <h3 class="text-base font-medium text-gray-800 mb-3">数据管理</h3>
          <div class="space-y-3">
        ...
        <!-- 关于信息 -->
        <div>
          <h3 class="text-base font-medium text-gray-800 mb-3">关于</h3>

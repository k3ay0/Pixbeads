...
<template>
 ...
 <button
 @click="handleSkip"
 class="px-4 py-1.5 text-sm text-black/25 hover:text-white transition-colors"
 >
 使用原图
 </button>
 <button
 @click="handleConfirm"
 class="px-4 py-1.5 text-sm bg-black text-white rounded-lg hover:bg-black/80 transition-colors"
 >
 确认裁剪
 </button>
 </div>
 ...
 <!-- Info bar -->
 <div class="bg-black px-4 py-2 text-xs text-black/35 text-center">

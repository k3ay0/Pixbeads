...
<template>
 ...
 <!-- 提醒内容 -->
 <div class="text-sm text-black/60 space-y-3">
 <div class="bg-[#ffbe2e]/[0.08] dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/40 rounded-lg p-3">
 ...
 <p class="text-black/70 dark:text-yellow-300">
 ...
 <div class="space-y-2">
 <p>专心拼豆模式特点：</p>
 <ul class="text-xs space-y-1 text-black/45 ">
 <li>• 专为手机优化的拼豆助手</li>
 <li>• 提供颜色引导和进度追踪</li>
 <li>• 支持触摸操作和缩放查看</li>
 <li>• 退出后将丢失当前编辑状态</li>
 ...
 <button
 @click="emit('proceed')"
 class="w-full py-2.5 px-4 bg-black/[0.04] hover:bg-black/10 text-black rounded-lg font-medium transition-all duration-200"
 >
 直接进入（不下载）
 </button>
 ...
 <button
 @click="emit('close')"
 class="w-full py-2 px-4 text-black/45 hover:text-black text-sm transition-colors"
 >
 取消
 </button>
 </div>

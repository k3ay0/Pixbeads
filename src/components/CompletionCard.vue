...
<template>
 ...
 <div class="text-black/60 space-y-1">
 ...
 <div v-if="cameraError" class="bg-[#ffbe2e]/[0.08] border border-[#ffbe2e]/20 rounded-lg p-3 mb-4">
 ...
 <button
 @click="startCamera"
 class="w-full bg-[#007be5] text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition-colors"
 >
 📸 开启相机拍照
 </button>
 <button
 @click="skipPhoto"
 class="w-full bg-black text-white px-6 py-3 rounded-lg hover:bg-green-600 transition-colors"
 >
 🎨 跳过拍照，使用作品图
 </button>
 </div>
 ...
 <button
 @click="takePhoto"
 class="bg-black text-white px-6 py-3 rounded-lg hover:bg-green-600 transition-colors mr-2"
 >
 📸 拍照
 </button>
 <button
 @click="cancelCapture"
 class="bg-black text-white px-4 py-3 rounded-lg hover:bg-black/70 transition-colors"
 >
 取消
 </button>
 </div>
 ...
 class="w-full bg-black text-white py-2 rounded-lg hover:bg-black/70 transition-colors"
 >
 重新拍照
 </button>
 </div>
 ...
 <button
 @click="emit('close')"
 class="w-full bg-black/[0.04] text-black/60 py-2 rounded-lg hover:bg-black/10 transition-colors"
 >
 稍后再说
 </button>
 </div>
